RSpec.describe CreditCard, type: :model do
  context 'when validations' do
    it { is_expected.to allow_values('a' * CreditCard::CARD_NAME_MAX_LENGTH).for(:name) }
  ...
  context 'when not validations' do
    it { is_expected.not_to allow_values('a' * CreditCard::CARD_NAME_MAX_LENGTH.next).for(:name) }
